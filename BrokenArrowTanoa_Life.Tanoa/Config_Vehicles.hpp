	...
	*/
	class civ_car {
		...
		vehicles[] = {
			...
			{ "C_Offroad_02_unarmed_F", 12500, "driver" }
		};
	};
	...
	class reb_car {
		...
		vehicles[] = {
			...
			{ "B_T_LSV_01_unarmed_F", 68000, "" },
			{ "B_T_LSV_01_armed_F", 1500000, "" }
		};
	};
	...
	class civ_air {
		...
		vehicles[] = {
			...
			{ "C_Plane_Civil_01_racing_F", 90000, "pilot" },
			{ "C_Plane_Civil_01_F", 60000, "pilot" },
		};
	};
...
class CfgVehicles {
    ...
    textures[] = {
			{ "Police", "cop", {
                "#(argb,45,71,116)color(0.05,0.05,0.05,1)"
            } },
            { "Purple", "Civ", {
                "#(argb,148,36,147)color(0.05,0.05,0.05,1)"
            } },
            { "Neon Green", "Civ", {
                "#(argb,206,249,103)color(0.05,0.05,0.05,1)"
            } },
            { "Dark Red", "Civ", {
                "#(argb,102,3,31)color(0.05,0.05,0.05,1)"
            } },
            { "Orange", "Civ", {
                "#(argb,255,135,29)color(0.05,0.05,0.05,1)"
            } },
            { "Grey", "Civ", {
                "#(argb,171,181,192)color(0.05,0.05,0.05,1)"
            } },
            { "Yellow", "Civ", {
                "#(argb,253,242,70)color(0.05,0.05,0.05,1)"
            } },
            { "Black", "Civ", {
