...
/* System Settings */
    ...
    respawn_timer = 90; //How many seconds a player should wait, before being able to respawn.
    ...
    house_limit = 8; //Maximum number of houses a player can own.
    ...
    bank_cop = 2000000; //Amount of cash in bank for new cops
    bank_civ = 2000000; //Amount of cash in bank for new civillians
    bank_med = 2000000; //Amount of cash in bank for new medics

    paycheck_period = 5; //Scaled in minutes
    paycheck_cop = 25000; //Payment for cops
    paycheck_civ = 20000; //Payment for civillians
