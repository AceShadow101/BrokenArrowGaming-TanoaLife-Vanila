...
if(life_markers) then {
	...
	[0,format["Admin %1 Has Turned On Markers.",profileName]] remoteExecCall ["life_fnc_broadcast",RCLIENT];
...
FinishedLoop = true;
	...
	[0,format["Admin %1 Has Turned OFF Markers.",profileName]] remoteExecCall ["life_fnc_broadcast",RCLIENT];
